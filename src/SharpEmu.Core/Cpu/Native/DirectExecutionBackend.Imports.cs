...
public sealed partial class DirectExecutionBackend
{
	...
	/// <summary>
	/// Ultra-thin path for the Demon's Souls boot memcpy/memmove storm: skip
	...
	private static bool IsNoBlockLeafImport(string nid) =>
		nid is
			...
			// Demon's Souls boot issues tens of millions of these; the import
			// call-frame bookkeeping on the non-NoBlock leaf path was a measurable
			// Rosetta tax on top of TryCopy itself.
