...
public static class PadExports
{
    ...
    // scePadOpen accepts an optional parameter pointer; scePadOpenExt additionally accepts
    // ports 1/2 (racing titles retry scePadOpenExt(type=2) forever if rejected).
