...
public sealed class Gen5SpirvAtomicTranslationTests
{
    ...
    [Fact]
    public void SilentHillRdna2Opcodes_TranslateToSpirv()
    {
        var opcodes = CompileCompute(
            [
        ...
        Assert.DoesNotContain((ushort)SpirvOp.ArrayLength, opcodes);
        Assert.DoesNotContain((ushort)SpirvOp.TypeRuntimeArray, opcodes);
    }
